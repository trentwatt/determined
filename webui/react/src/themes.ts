...
import {
  BrandingType, CheckpointState, CommandState, DarkLight,
  JobState, ResourceState, RunState, SlotState,
} from 'types';
>>>>>>> 48003e50c (squash)
...
const themeBase = {
  ...
  // Status styles.
  statusActive: 'rgba(23, 125, 220, 1.0)',
  ...
  statusCritical: 'rgba(255, 78, 79, 1.0)',
  ...
  statusSuccess: 'rgba(82, 196, 26, 1.0)',
  ...
  statusWarning: 'rgba(250, 173, 21, 1.0)',
...
const themeLight = {
  ...
  ixOnInactive: 'rgba(135, 135, 135, 1.0)',
  ixBorder: 'rgba(150, 150, 150, 1.0)',
  ixBorderActive: 'rgba(0, 155, 222, 1.0)',
  ixBorderInactive: 'rgba(185, 185, 185, 1.0)',
...
const themeDark = {
  ...
  ixOnInactive: 'rgba(120, 120, 120, 1.0)',
  ixBorder: 'rgba(150, 150, 150, 1.0)',
  ixBorderActive: 'rgba(23, 125, 220, 1.0)',
  ixBorderInactive: 'rgba(70, 70, 70, 1.0)',
